...
const Lunyi: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  const style = _style ? { ...DEFAULT_STYLE, ..._style } : DEFAULT_STYLE;

  return (
    <svg viewBox="0 0 24 24" width={size + 'rem'} height={size + 'rem'} style={style} {...rest}>
      <circle
